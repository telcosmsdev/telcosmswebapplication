        ...
        <div class="pricing-area text-center">
            <div class="row">
                <div class="col-sm-5 col-sm-offset-1 plan price-one wow fadeInDown">
                    <ul>
                        <li class="heading-four">
                            ...
                            <h1><button class="btn btn-primary" type="submit" > Criar Cliente </h1>
                                </form>
                    </ul>
                </div>
                ...
                <div class="col-sm-5 plan price-six wow fadeInDown">
                    <ul>
                        <li class="heading-four">
                            <form action="listar_clientes.php">
                                <h1><button class="btn btn-primary" type="submit" > Listar Clientes </h1>
                            </form>
                        </li>
                    </ul>
                </div>
